 ...
 *
 * This demonstrates how to wrap AgentDoor-enabled services as LangChain
 * tools so that an LLM agent can autonomously discover, register with,
 * and call external APIs — all without browser automation.
 *
 * Flow:
 *   1. AgentDoor SDK connects to a service (discover -> register -> verify)
...
san-francisco, new-york, austin, london, and tokyo.`,
  ...
  // ---------------------------------------------------------------
  //
  // You can connect to any number of AgentDoor-enabled services and
